...
2. If you're still seeing the error, check to see if somebody else has [already filed the issue](https://github.com/daily-demos/svelte-daily-prebuilt/issues) before creating a new one.
